            ...
            <DrawerContentScrollView {...props}>
                ...
                <View style={{ marginTop: 40,height:550}}>
                    ...
                    <Drawer.Section style={{  marginTop: 15,margin:20,flex:1 }}>
                        ...
                        {/* New Drawer Item */}
                        <DrawerItem style={{ backgroundColor: colors.darkLight, borderRadius: 10 }} label={() => (<Text style={{ fontSize: 20, textAlign: 'center', color: 'white' }}>Splash Screen</Text>)} onPress={() => props.navigation.navigate("SplashScreen")} />
